...
Durable root: `$XDG_STATE_HOME/stegverse/repo-ledgers/Admissible-Existence/ECAT-ICAT`

Receipts are append-only/hash-linked. Only evidence needed for organization reconstruction propagates to `Admissible-Existence/.github`. Recording grants no authority.
